  ...
  return (
    <section aria-labelledby="events-title" className="px-5 pt-12 pb-10">
      ...
      <div className="mt-4 flex justify-end">
        ...
        <select
          className="min-h-10 rounded-full border border-neutral-300 bg-white px-4 text-sm font-bold tracking-[-0.02em] text-neutral-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-950"
          id="event-start-sort"
